...
import type { CreateRolloverScenarioInput, RolloverScenario, ScenarioDrift } from '../types/rollover-scenario'
...
export const rolloverScenarioApi = {
  ...
  drift: (id: number) => apiRequest<ScenarioDrift>(`/rollover-scenarios/${id}/drift`),
